...
public class CommController extends HttpServlet {
    ...
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int n = 0;
        try {
            n = DaoFactory.getCommDaoInstance().deleteCommById(Integer.parseInt(id));
//            n = DaoFactory.getUserDaoInstance().deleteUserById(Integer.parseInt(id));
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Gson gson = new GsonBuilder().create();
        Comm comm = gson.fromJson(stringBuilder.toString(), Comm.class);
        int n = 0;
        try {
            n = DaoFactory.getCommDaoInstance().updateComm(comm);
        } catch (SQLException e) {
            e.printStackTrace();
        }
        resp.setContentType("application/json;charset=utf-8");
